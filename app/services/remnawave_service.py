...
class RemnaWaveService:
        ...
        *,
        ...
        try:
            ...
            panel_squad_uuids = merge_panel_squads(
                panel_squad_uuids,
                subscription.connected_squads,
                dimension_squad_policy.stripped_for(subscription.remnawave_id),
            )
    ...
    async def read_inbound_usage(
        ...
        *,
        ...
        try:
            ...
            logger.warning('Failed to fetch per-inbound usage', panel_user_id=panel_user_id, error=e)
    ...
    async def measure_dimension_usage(
        ...
        *,
        ...
        reading = await self.read_inbound_usage(panel_user_id, window_start, end_date, api=api)
